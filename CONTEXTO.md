...
- Python 3.11.9 + pip funcional. Pacotes: requests, kokoro-onnx 0.6.1, edge-tts 7.2.8, numpy 2.4.6, onnxruntime, phonemizer, espeakng-loader, soundfile 0.14.0.
...
## 4. Estado atual
- Sessao 1 concluida: ambiente de audio pronto. Pipeline ainda inexistente.
