...
- E2E (2026-09-17): 1a execucao (02:34:21) = registro id=1, 20 noticias (HN + Reddit), roteiro de 3185 chars, audio de 201,33 s (4.831.903 amostras, 24000 Hz, PCM_16, 11 chunks, 9.663.850 B); o audio dessa execucao esta preservado em audio/boletim_2026-09-17_primeira_execucao.wav porque o nome do WAV usa a data do dia. 2a execucao (04:15:57) = registro id=2, 20 noticias, 121,07 s, gravada em audio/boletim_2026-09-17.wav. boletim.db (8192 B) concentra os dois registros.
